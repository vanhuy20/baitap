...
//  Kiểm tra mảng có bao nhiêu số chẵn, bao nhiêu số lẻ . In kết quả ra màn hình.
...
echo ("Mảng sắp sếp theo thứ tự tăng dần: ");
echo "[";
for($i = 0; $i < 10; $i++) {
    echo ($array[$i] . ", ");
}
...
echo ("Mảng sắp sếp theo thứ tự giảm dần: ");
echo "[";
for($i = 0; $i < 10; $i++) {
    echo ($array[$i] . ", ");
}

<?php
// 12.1: Viết chương trình tính tổng các số từ 1 đến 100.
$sum = 0;
for($i = 1; $i <= 100; $i++) {
    $sum += $i;
}

echo ("Tổng các số từ 1 => 100 = ".$sum);
echo "<br>";


//  12.2: Viết chương trình nhập vào một số tự nhiên n. Tính tổng các số chia hết cho 3 bé hơn n.
...
echo ("Tổng các số chia hết cho 3 bé hơn " . $n . " = " .$sum2);
echo "<br>";
echo "<br>";


// 12.3: Viết chương trình in ra 100 số Fibonacci đầu tiên.
...
// 12.4: Viết chương trình kiểm tra một số nguyên n có phải là số polinom.
...
// 12.5: Viết chương trình liệt kê các số từ 100 đến 999 có tổng các chữ số chia hết cho 3.
